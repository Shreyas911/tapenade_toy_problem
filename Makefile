...
driver.o: forward_db.f90 forward_diff.mod 
forward_diff.mod: forward_db.o
...
forward_db.f90: forward.f90
		tapenade -reverse -tangent -head "forward_problem(V)/(xx)" forward.f90
